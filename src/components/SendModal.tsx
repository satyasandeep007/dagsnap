        ...
        <div className="bg-indigo-50 p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-lg font-semibold text-gray-800">SEND</h2>
            </div>
          ...
          <div className="mb-6">
            <label className="block text-base font-medium text-[#92A5B5] mb-1">Amount</label>
            <div className="flex items-center justify-between bg-indigo-50">
              <div className="flex items-center w-2/5 bg-indigo-50">
                <input
                  type="text"
                ...
                />
                <div className="text-[#1F2FCD] font-semibold ml-2">DAG</div>
              </div>
              <button onClick={handleMax} className="bg-indigo-200 text-[#1F2FCD] px-4 py-1 rounded-xl text-sm">
                MAX
              </button>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center text-md text-gray-500 mb-4 py-2">
            <span className="font-semibold text-[#1F2FCD]">
              {amount ? (parseFloat(amount) * marketPrice).toFixed(2) : '0.00'} USD
            </span>
            <div className="flex items-center space-x-2">
              <span className="mr-4 font-semibold text-[#92A5B5]">Fee</span>
              <span className="font-semibold"> 0 DAG</span>
          ...
          <div className="mb-4 border-t border-[#BCCEF9] pt-4">
            <div className="flex justify-between text-md text-[#7991A4]">
              ...
              <span>
                {balance} DAG / {balance ? (parseFloat(balance) * marketPrice).toFixed(2) : '0.00'} USD
              </span>
            </div>
          </div>
        </div>
