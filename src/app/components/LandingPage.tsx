      ...
      <div className="bg-white shadow-xl rounded-lg max-w-6xl w-full p-10 mx-auto my-10 max-h-[100vh] overflow-auto">
        ...
        <div className="flex justify-between items-center">
          <div className="text-xl font-bold text-gray-800 flex items-center">
            <img src="https://via.placeholder.com/40" alt="DAGSNAP Logo" className="mr-3" />
            DAGSNAP
          </div>
          ...
          <div className="w-3/4">
            ...
            <div>
              <div className="border-b pb-3 mb-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <img src="https://via.placeholder.com/30" alt="Bitcoin Logo" className="mr-3" />
                    <div>
              ...
              <div className="border-b pb-3 mb-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <img src="https://via.placeholder.com/30" alt="Ethereum Logo" className="mr-3" />
                    <div>
              ...
              <div className="border-b pb-3 mb-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <img src="https://via.placeholder.com/30" alt="Tether Logo" className="mr-3" />
                    <div>
              ...
              <div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <img src="https://via.placeholder.com/30" alt="Cardano Logo" className="mr-3" />
                    <div>
            ...
            <div className="mt-6 text-blue-500 font-bold">View all transactions</div>
          </div>
